...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSqlRecoveryPoint>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkloadSqlRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(WorkloadSqlRecoveryPoint)} does not support '{format}' format.");
            }
        ...
        internal static WorkloadSqlRecoveryPoint DeserializeWorkloadSqlRecoveryPoint(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkloadSqlRecoveryPoint(objectType, serializedAdditionalRawData, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, extendedInfo.Value);
        }
        ...
        BinaryData IPersistableModel<WorkloadSqlRecoveryPoint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(WorkloadSqlRecoveryPoint)} does not support '{options.Format}' format.");
            }
        }
